...
2. **點擊「Deploy with Vercel」按鈕**：
   - 在 README 頁面頂部
   - 或直接前往：https://vercel.com/new/clone?repository-url=https://github.com/con2000us/Wilbur-s-rewardbook&env=NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,SITE_PASSWORD
